...
// ─── PRICING ────────────────────────────────────────────────────────────────
{
  ...
  values: {
    ...
    'ig-byo': 'Unlimited',
    'ig-unlimited': 'Unlimited',
    'amp-free': '2M events/mo',
    'amp-plus': 'Up to 700K MTU / 70M events',
    'amp-growth': 'Custom (event-based)',
    'amp-enterprise': 'Custom (event-based)',
    'sl-core': 'Up to 100k store visitors',
    'sl-advanced': 'Up to 1m store visitors',
    'sl-pro': 'Up to 1m store visitors. Gated pricing thereafter',
    'vis-launch': 'Order-based (orders/mo)',
    'vis-pro': 'Order-based (orders/mo)',
    'vis-scale': 'Order-based (orders/mo)',
    'zps-free': 'Up to 5,000 MTUs/month',
    'zps-pro': '10,000–1,000,000 MTUs/month',
    'zps-enterprise': '10,000–1,000,000 MTUs/month',
    'zps-agency': '10,000–1,000,000 MTUs/month'
  }
}, {
  ...
  values: {
    ...
    'ig-byo': '$69 - $13,999/mo',
    'ig-unlimited': '$349 - $13,999/mo',
    'amp-free': 'Free',
    'amp-plus': '$0-~$4,865/mo',
    'amp-growth': 'Contact Sales',
    'amp-enterprise': 'Contact Sales',
    'sl-core': '$99/mo - $199/mo',
    'sl-advanced': '$399/mo - $999/mo',
    'sl-pro': 'Annual only',
    'vis-launch': '$15 - $1,820 (then gated)',
    'vis-pro': '$900 - $3,640 (then gated)',
    'vis-scale': '$2,500 - $5,240 (then gated)',
    'zps-free': '$0/month',
    'zps-pro': '$20 - $699 per month',
    'zps-enterprise': '$49 - $1299 per month',
  ...
  values: {
    ...
    'vis-launch': '$13 - $1,638/mo',
    'vis-pro': '$810 - $3,276/mo',
    'vis-scale': '$2,250 - $4,716/mo',
    'zps-free': '$0/month',
    'zps-pro': '$12 - $420 per month',
    'zps-enterprise': '$30 - $780 per month',
    'zps-agency': '$24.50 - $519 per month'
  }
}, {
  ...
  values: {
    ...
    'kam-enterprise': 'Gated pricing',
    'dy-single': 'Gated pricing',
    'ig-byo': '$660 - $134,388/year',
    'ig-unlimited': '$3,468 - $134,388/year',
    'amp-free': 'Free',
    'amp-plus': '$0-~$56,124/yr',
    'amp-growth': 'Contact Sales',
    'amp-enterprise': 'Contact Sales',
    'sl-core': '$888/yr - $1788/yr',
    'sl-advanced': '$3588/yr - $8988/yr',
    'sl-pro': '$8388/yr - $17988/yr',
    'vis-launch': '$156 - $19,656',
    'vis-pro': '$9,720 - $39,312',
    'vis-scale': '$27,000 - $56,592',
    'zps-free': '$0',
    'zps-pro': '$144 - $5040 per year',
    'zps-enterprise': '$360 - $9360 per year',
    'zps-agency': '$294 - $6235 per year'
  }
}, {
  ...
  values: {
    ...
    'dy-single': 'Unknown',
    'ig-byo': 'Not specified',
    'ig-unlimited': 'Not specified',
    'amp-free': 'Unknown',
    'amp-plus': 'Unknown',
    'amp-growth': 'Unknown',
  ...
  values: {
    ...
    'ig-byo': 'Automatic',
    'ig-unlimited': 'Automatic',
    'amp-free': 'If data sent is over limit, user loses access to their account',
...
// ─── SCALE ──────────────────────────────────────────────────────────────────
{
  ...
  values: {
    ...
    'vis-launch': 'Plan depedent - store based',
    'vis-pro': 'Plan depedent - store based',
    'vis-scale': 'Plan depedent - store based',
    'zps-free': 'N/A',
    'zps-pro': 'N/A',
    'zps-enterprise': 'Unknown',
    'zps-agency': 'Unknown'
  ...
  values: {
    ...
    'vwo-pro': 'Unlimited',
    'vwo-enterprise': 'Unlimited',
    'kam-standard': 'No — up to 10 experiments',
  ...
  values: {
    ...
    'vwo-pro': 'Unlimited',
    'vwo-enterprise': 'Unlimited',
    'kam-standard': 'No — AI credits: 30/100/200 per mo',
    'kam-enterprise': 'Yes — unlimited',
    'dy-single': true,
    'ig-byo': true,
    'ig-unlimited': true,
  ...
  values: {
    ...
    'convert-pro': '30',
    'convert-enterprise': 'Unlimited',
    'opt-single': 'Limit not specified',
    'vwo-growth': '1',
    'vwo-pro': '3',
    'vwo-enterprise': '5',
    ...
    'amp-free': '1 Space',
    'amp-plus': '3 Spaces',
    'amp-growth': 'Unlimited Spaces',
    'amp-enterprise': 'Unlimited Spaces',
    'sl-core': 'N/A',
    'sl-advanced': 'N/A',
    'sl-pro': 'N/A',
    'vis-launch': false,
...
// ─── FEATURES ────────────────────────────────────────────────────────────────
{
  ...
  values: {
    ...
    'opt-single': 'With Feature Experimentation',
  ...
  values: {
    ...
    'amp-growth': false,
    'amp-enterprise': true,
    'sl-core': 'Yes (automatic)',
    'sl-advanced': 'Yes (automatic)',
    'sl-pro': 'Yes (automatic)',
    'vis-launch': 'Unknown',
    'vis-pro': 'Unknown',
    'vis-scale': 'Unknown',
    'zps-free': false,
  ...
  values: {
    ...
    'ig-byo': true,
    'ig-unlimited': true,
    'amp-free': 'Amplitude Audiences required',
    'amp-plus': true,
    'amp-growth': true,
    'amp-enterprise': true,
    'sl-core': false,
  ...
  values: {
    ...
    'convert-pro': true,
    'convert-enterprise': true,
    'opt-single': 'Sequential testing and false discovery rate controls',
    ...
    'kam-enterprise': true,
    'dy-single': 'Yes — both',
    'ig-byo': 'Bayesian only (Monte Carlo)',
    'ig-unlimited': 'Bayesian only (Monte Carlo)',
    'amp-free': 'Sequential Testing or T Test',
  ...
  values: {
    ...
    'vis-pro': true,
    'vis-scale': true,
    'zps-free': 'Yes — async snippet option HOVER: async snippet option',
    'zps-pro': 'Yes — async snippet option HOVER: async snippet option',
    'zps-enterprise': 'Yes — async snippet option HOVER: async snippet option',
    'zps-agency': 'Yes — async snippet option HOVER: async snippet option'
  }
}, {
  ...
  values: {
    'convert-growth': 'Upon Location Run Only',
    'convert-pro': true,
    'convert-enterprise': true,
    'opt-single': true,
    'vwo-growth': false,
  ...
  values: {
    ...
    'convert-pro': true,
    'convert-enterprise': true,
    'opt-single': 'Not available for web experimentation',
    'vwo-growth': false,
    'vwo-pro': false,
    'vwo-enterprise': false,
    'kam-standard': false,
    ...
    'zps-free': false,
    'zps-pro': false,
    'zps-enterprise': 'Available in Full Stack only',
    'zps-agency': 'Available in Full Stack only'
  }
}, {
  ...
  values: {
    ...
    'amp-growth': true,
    'amp-enterprise': true,
    'sl-core': 'Yes (REST API)',
    'sl-advanced': 'Yes (REST + JS API)',
    'sl-pro': 'Yes (REST + JS API)',
    'vis-launch': true,
    'vis-pro': true,
    'vis-scale': true,
    'zps-free': 'Unknown',
  ...
  values: {
    ...
    'ig-byo': true,
    'ig-unlimited': true,
    'amp-free': 'For some integrations there are modals that allow you to easily integrate with selected apps',
    'amp-plus': true,
    'amp-growth': true,
    'amp-enterprise': true,
    'sl-core': true,
  ...
  values: {
    ...
    'amp-growth': true,
    'amp-enterprise': true,
    'sl-core': 'No (Heatmap.com integr.)',
    'sl-advanced': 'No (Heatmap.com integr.)',
    'sl-pro': 'No (Heatmap.com integr.)',
  ...
  values: {
    ...
    'dy-single': true,
    'ig-byo': 'Smart Merchandising module',
    'ig-unlimited': 'Partial',
    'amp-free': true,
    'amp-plus': true,
    'amp-growth': true,
    'amp-enterprise': true,
  ...
  dimension: 'features',
  tooltip: 'Model Context Protocol server so AI assistants like Claude, Cursor and VS Code can securely connect to and query the product\'s data',
  values: {
    'convert-growth': true,
    'convert-pro': true,
    'convert-enterprise': true,
  ...
  attribute: 'Shopify price testing',
  dimension: 'features',
  tooltip: 'Native, checkout-safe A/B or multivariate testing of product and checkout pricing on a Shopify store, without exposing test logic client-side',
  values: {
    'convert-growth': true,
    'convert-pro': true,
    'convert-enterprise': true,
  ...
  attribute: 'AI Assistant',
  dimension: 'features',
  tooltip: 'Built-in AI that generates test variations, copy or insights inside the product\'s editor',
  values: {
    'convert-growth': true,
    'convert-pro': true,
    'convert-enterprise': true,
...
// ─── GOVERNANCE ──────────────────────────────────────────────────────────────
{
  ...
  values: {
    'convert-growth': 'true HOVER: Convert Experiences is SOC 2 Type 2 attested, included on every paid plan',
    'convert-pro': 'true HOVER: Convert Experiences is SOC 2 Type 2 attested, included on every paid plan',
    'convert-enterprise': 'true HOVER: Convert Experiences is SOC 2 Type 2 attested, included on every paid plan',
    'opt-single': true,
    'vwo-growth': true,
    'vwo-pro': true,
    'vwo-enterprise': true,
  ...
  dimension: 'governance',
  values: {
    'convert-growth': 'true HOVER: Convert Experiences is ISO 27001:2022 certified by InterCert, included on every paid plan',
    'convert-pro': 'true HOVER: Convert Experiences is ISO 27001:2022 certified by InterCert, included on every paid plan',
    'convert-enterprise': 'true HOVER: Convert Experiences is ISO 27001:2022 certified by InterCert, included on every paid plan',
    'opt-single': true,
    'vwo-growth': true,
    'vwo-pro': true,
    'vwo-enterprise': true,
  ...
  values: {
    ...
    'vwo-enterprise': true,
    'kam-standard': false,
    'kam-enterprise': 'Paid add on',
    'dy-single': true,
    'ig-byo': 'Login via Shopify',
    'ig-unlimited': 'Login via Shopify',
    'amp-free': false,
    'amp-plus': false,
    'amp-growth': true,
    'amp-enterprise': true,
    'sl-core': 'Signon via Shopify',
    'sl-advanced': 'Signon via Shopify',
    'sl-pro': 'Signon via Shopify',
    'vis-launch': 'Signon via Shopify',
    'vis-pro': 'Signon via Shopify',
    'vis-scale': 'Signon via Shopify',
    'zps-free': true,
    'zps-pro': true,
    'zps-enterprise': true,
    'zps-agency': true
  ...
  values: {
    ...
    'kam-enterprise': true,
    'dy-single': true,
    'ig-byo': 'Dependent on Shopify plan',
    'ig-unlimited': 'Dependent on Shopify plan',
    'amp-free': 'Limited',
    'amp-plus': 'Limited',
    'amp-growth': true,
    'amp-enterprise': 'Yes (advanced + SCIM)',
    'sl-core': 'No (Shopify app perms)',
    'sl-advanced': 'No (Shopify app perms)',
    'sl-pro': 'No (Shopify app perms)',
    'vis-launch': true,
    'vis-pro': true,
    'vis-scale': true,
    'zps-free': true,
  ...
  values: {
    ...
    'ig-byo': 'Not specified',
    'ig-unlimited': 'Not specified',
    'amp-free': 'Not specified in Privacy policy',
    'amp-plus': 'Unknown',
    'amp-growth': 'Unknown',
    'amp-enterprise': 'Unknown',
    'sl-core': 'Unknown',
...
// ─── SUPPORT ─────────────────────────────────────────────────────────────────
{
  ...
  values: {
    ...
    'amp-plus': false,
    'amp-growth': false,
    'amp-enterprise': 'Premium Success plan only',
    'sl-core': true,
    'sl-advanced': true,
    'sl-pro': true,
    'vis-launch': true,
